...
public class AuthController {
    ...
    public ResponseResult<Void> sendVerificationCode(
        ...
        accountService.sendVerificationCode(email, type);
    ...
    @PutMapping("/reset")
    @SaCheckLogin
    @Operation(summary = "更新用户密码", description = "通过邮箱更新用户的密码")
    @ApiResponse(responseCode = "200", description = "成功更新用户密码")
    public ResponseResult<Void> updatePassword(@RequestBody ResetPasswordDto dto) {
        return ResponseResult.okResult(accountService.resetPassword(dto));
    }
}